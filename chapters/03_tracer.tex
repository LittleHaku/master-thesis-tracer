...
of the tool's two-phase implementation in \autoref{sec:overview}.
...
\begin{itemize}
  \item \textbf{Informational:}
    ...
    Examples of these are university or bank chatbots that only give you information
    or if you need to do any paperwork they will give you a link and redirect you
    but they will not assist you with the transaction directly.
