...
\begin{figure}[htpb]
  \centering
  \makebox[\textwidth][c]{
    \includegraphics[width=1\textwidth]{figures/cropped-ss/setup-guide.png}
  }
...
\begin{figure}[!htb]
  \centering
  \makebox[\textwidth][c]{
    \includegraphics[width=1\textwidth]{figures/cropped-ss/profile-shot.png}
  }
...
\begin{figure}[htb!]
  ...
  \makebox[\textwidth][c]{
    \begin{subfigure}[c]{0.52\textwidth}
      \centering
      \includegraphics[width=\linewidth]{figures/cropped-ss/create-connector.png}
      \caption{Create new connector modal.}
...
\begin{figure}[!htb]
  \centering
  \makebox[\textwidth][c]{
    \includegraphics[width=1.2\textwidth]{figures/cropped-ss/test-center-full-shot.png}
  }
...
\begin{figure}[htpb]
  \centering
  \makebox[\textwidth][c]{
    \includegraphics[width=1.1\textwidth]{figures/cropped-ss/sensei-dashboard.png}
  }
...
\begin{figure}[htpb]
  \centering
  \makebox[\textwidth][c]{
    \includegraphics[width=1\textwidth]{figures/cropped-ss/tracer-dashboard.png}
  }
