...
\begin{figure}[htpb]
  \centering
  \makebox[\textwidth][c]{
    \includegraphics[width=1.1\textwidth]{figures/web-screenshots/create-new-connector.png}
  }
...
\begin{figure}[htpb]
  \centering
  \makebox[\textwidth][c]{
    \includegraphics[width=1.1\textwidth]{figures/web-screenshots/create-project-modal.png}
  }
...
\begin{figure}[htpb]
  \centering
  \makebox[\textwidth][c]{
    \includegraphics[width=1.1\textwidth]{figures/web-screenshots/tracer-dashboard.png}
  }
...
\begin{figure}[htpb]
  \centering
  \makebox[\textwidth][c]{
    \includegraphics[width=1.1\textwidth]{figures/web-screenshots/sensei-dashboard.png}
  }
