...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        % Style for Layer titles 
        layer_label/.style={font=\small\bfseries, rounded corners=3pt, inner sep=3pt,
                         fill=darkgray!25, fill opacity=0.8, text opacity=1}
    ]
    ...
    \draw[data_arrow] (django.east) to[bend left=15] node[label_bg, above, pos=0.25] {queries} (postgres.west);
